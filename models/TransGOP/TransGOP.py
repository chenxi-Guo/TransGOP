...
from .gazeregressor import build_gatector
...
class TransGOP(nn.Module):
    ...
    def forward(self, samples: NestedTensor,face, head_channel, targets:List=None):
        ...
        gatector_scene_feature = features[2]
        ...
        gaze_outputs = self.gatector(gatector_scene_feature, head_channel, face, od_memory, od_pos, od_mask)
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='TransGOP')
def build_TransGOP(args):
